...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Need to name the column";
    			attr_dev(p, "class", "text-red-400");
    			add_location(p, file, 68, 1, 1693);
    		},
    ...
    // (85:6) {#each column.items as item}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(85:6) {#each column.items as item}",
    		ctx
    	});
    ...
    // (75:0) {#each app.columns as column}
    function create_each_block(ctx) {
    	let div1;
    	let h3;
    	let t0_value = /*column*/ ctx[10].title + "";
    	let t0;
    	let t1;
    	let button;
    	let t3;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[8](/*column*/ ctx[10]);
    	}

    	let each_value_1 = /*column*/ ctx[10].items;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			add_location(h3, file, 76, 4, 1939);
    			add_location(button, file, 77, 4, 1968);
    			attr_dev(div0, "class", "column svelte-1madkrt");
    			add_location(div0, file, 78, 4, 2035);
    			add_location(div1, file, 75, 2, 1928);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					action_destroyer(dndzone.call(null, div0, {
    						items: /*column*/ ctx[10].items,
    						flipDurationMs: 0,
    						dropFromOthersDisabled: false,
    						dropTargetStyle: {},
    						centreDraggedOnCursor: true
    					})),
    					listen_dev(div0, "consider", /*handleDrop*/ ctx[5], false, false, false, false),
    					listen_dev(div0, "finalize", /*handleDrop*/ ctx[5], false, false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*app*/ 4) {
    				each_value_1 = /*column*/ ctx[10].items;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:0) {#each app.columns as column}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*inputEmpty*/ ctx[1] && create_if_block(ctx);
    	let each_value = /*app*/ ctx[2].columns;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			button = element("button");
    			button.textContent = "Create Column";
    			t3 = space();
    			...
    			attr_dev(input, "placeholder", "Enter column title");
    			add_location(input, file, 71, 0, 1755);
    			add_location(button, file, 72, 0, 1820);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*textInput*/ ctx[0]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*textInput*/ 1 && input.value !== /*textInput*/ ctx[0]) {
    				set_input_value(input, /*textInput*/ ctx[0]);
    			}

    			if (dirty & /*app, handleDrop, addItem*/ 52) {
    				each_value = /*app*/ ctx[2].columns;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function createColumn(title) {
    		if (textInput !== '') {
    			...
    			$$invalidate(0, textInput = ''); // Clear the input after adding column
    		} else {
    			$$invalidate(1, inputEmpty = true);
    		}
    	}
    	...
    	const click_handler = () => createColumn(textInput);
    	const click_handler_1 = column => addItem(column.id);
    	...
    	$$self.$inject_state = $$props => {
    		if ('theApp' in $$props) theApp = $$props.theApp;
    		if ('textInput' in $$props) $$invalidate(0, textInput = $$props.textInput);
    		if ('inputEmpty' in $$props) $$invalidate(1, inputEmpty = $$props.inputEmpty);
    	};
